...
public class RobotState {
    ...
    private static final InterpolatingDoubleTreeMap speakerShooterAngleMap = new InterpolatingDoubleTreeMap();
    static {
        speakerShooterAngleMap.put(1.5, 12.71);
        speakerShooterAngleMap.put(2.0, 21.00);
        speakerShooterAngleMap.put(2.5, 24.89);
        speakerShooterAngleMap.put(3.0, 29.00);
        speakerShooterAngleMap.put(3.5, 31.20);
        speakerShooterAngleMap.put(4.0, 32.50);
        speakerShooterAngleMap.put(4.5, 34.00);
        speakerShooterAngleMap.put(5.0, 35.00);
    }

    private static final InterpolatingDoubleTreeMap feedShooterAngleMap = new InterpolatingDoubleTreeMap();
    static {
        feedShooterAngleMap.put(5.0, 0.0);
        feedShooterAngleMap.put(6.0, -10.0);
        feedShooterAngleMap.put(7.0, -19.0);
    }

    public double getShotAngle() {
        switch (target) {
            case SPEAKER:
                return speakerShooterAngleMap.get(getDistanceToTarget());
            case FEED:
                return feedShooterAngleMap.get(getDistanceToTarget());
            default:
                return 0.0;
        }
    }
